...
// RenderTreeStore calculates the treestore ID for the given image key
// The ID may change for the some key if the underlaying image dependencies
// change
...
// return the id if the rendered treestore.
