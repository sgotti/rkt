...
// Remove cleans the directory for the specified id
...
// GetPath returns the absolute path of the treestore for the specified id.
...
// GetRootFS returns the absolute path of the rootfs for the specified id.
