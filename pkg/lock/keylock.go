...
func (l *KeyLock) TryExclusiveKeyLock() error {
	return l.lock(true, true, defaultLockRetries)
}
...
func (l *KeyLock) ExclusiveKeyLock() error {
	return l.lock(false, true, defaultLockRetries)
}
...
func (l *KeyLock) TrySharedKeyLock() error {
	return l.lock(true, false, defaultLockRetries)
}
...
func (l *KeyLock) SharedKeyLock() error {
	return l.lock(false, false, defaultLockRetries)
}
...
func createAndLock(lockDir string, key string, try bool, exclusive bool) (*KeyLock, error) {
	...
	err = keyLock.lock(try, exclusive, defaultLockRetries)
	if err != nil {
		return nil, err
	}
	return keyLock, nil
...
func (l *KeyLock) lock(try bool, exclusive bool, maxRetries int) error {
	retries := 0
	for {
		var err error
		switch {
